  ...
  return (
    <div className="flex h-screen flex-col bg-white">
      ...
      ${
        isSent
          ...
          >
            <div className="w-full px-6 py-5 bg-indigo-50 rounded-2xl shadow-[0px_1px_4px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-1px] outline-indigo-500 flex justify-start items-start gap-3">
              ...
              <p className="text-base font-semibold font-['SUIT_Variable'] leading-6 text-gray-800">
        ...
        <div className="w-full px-4 py-6 bg-white flex flex-col gap-4 font-suit">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-bold">멋사 OB 밴드</h2>
              <div className="flex gap-1">
                {perf.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2.5 py-1 bg-rose-50 rounded-full text-pink-500 text-sm"
                  >
                    #{tag}
                  </span>
                ))}
            ...
            <div className="flex flex-col gap-2 text-slate-600">
              <div className="text-base font-semibold">{perf.location}</div>
              <div className="flex items-center gap-1 pb-0 text-sm">
                <img src="/public/booth/performance/icon-clock.svg" />
                <span>{perf.time}</span>
              </div>

              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1">
                  <img src="/public/booth/performance/icon-instagram.svg" />
                  <span className="px-2 py-0.5 bg-gray-100 rounded-full text-xs">
                    {perf.instagram}
                  </span>
                </div>
                <div className="flex items-center gap-1 pt-1.5">
                  <img src="/public/booth/performance/icon-youtube.svg" />
                  <span className="px-2 py-0.5 bg-gray-100 rounded-full text-xs">
                    {perf.youtube}
                  </span>
                </div>
        ...
        >
          {/* 셋리스트 타이틀 */}
          <div className="justify-start text-base font-semibold leading-6">
            셋리스트
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="inline-flex flex-col justify-start items-start">
                    ...
                    <div className="justify-start text-xs font-normal leading-4">
                      {song.artist}
                    </div>
                  </div>
                </div>
        ...
        <div className="inline-flex w-full flex-col items-center justify-start gap-4 bg-white px-4">
          ...
          <div className="flex w-96 overflow-hidden flex-col items-start justify-center gap-4 rounded-2xl bg-white p-6 shadow-[0px_1px_4px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-1px] outline-gray-100">
            ...
            <div className="flex self-stretch flex-col items-start justify-start gap-2">
              <div className="self-stretch text-base font-semibold leading-6 text-slate-600">
                가장 좋았던 곡
              </div>
            ...
            <div className="flex self-stretch flex-col items-start justify-start gap-2">
              ...
              <div className="inline-flex self-stretch items-start justify-start gap-2 rounded-lg bg-gray-100 px-5 py-3.5">
                <textarea
                  className="flex-1 bg-transparent text-sm font-normal leading-5 text-[#1F242C] placeholder:text-gray-400 focus:outline-none resize-none"
          ...
          >
            <div className="text-center text-base font-semibold leading-6 text-white">
              ♥ 응원메세지 보내기
            </div>
          </button>
        </div>
