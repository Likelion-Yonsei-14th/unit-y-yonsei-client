...
const CHARACTER_URL = "https://www.figma.com/api/mcp/asset/d023c56a-6ed9-4f41-9afd-a71f39484a61";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col items-center px-[16px] py-[36px] gap-[24px] overflow-y-auto">
        ...
        <div className="w-full bg-[#E9EEFF] border border-[#1E53FF] rounded-[14px] px-[24px] py-[20px] shadow-[0px_1px_4px_rgba(0,0,0,0.08)]">
          <div className="flex gap-[10px] items-start">
            <span className="text-[14px] font-semibold text-[#0D0F12] shrink-0">🎉</span>
            <span className="text-[14px] font-semibold text-[#0D0F12] leading-[1.5] tracking-[-0.3px]">
              소중한 만족도 평가로 젤리:U가 별을 얻었어요!<br />
              리뷰까지 남겨주시면 젤리:U가 윙크를 보여준대요
            </span>
          </div>
        </div>
        ...
        <div className="w-full bg-white border border-[#EDEEF0] rounded-[14px] px-[24px] py-[20px] shadow-[0px_1px_4px_rgba(0,0,0,0.08)] flex flex-col gap-[12px]">
          <div className="flex flex-col gap-[12px]">
            <span className="text-[17px] font-semibold text-[#0D0F12] tracking-[-0.34px] leading-[1.3]">
              💬 피드백 및 건의사항
            </span>
            <span className="text-[14px] text-[#4A5568] tracking-[-0.28px] leading-[1.5]">
          ...
          <textarea
            ...
            className="w-full min-h-[120px] bg-[#EDEEF0] rounded-[8px] px-[20px] py-[14px] text-[14px] text-[#4A5568] tracking-[-0.28px] leading-[1.5] resize-none outline-none"
          />
        </div>
      </div>
      ...
      <div className="px-[16px] pb-[12px] shrink-0">
        ...
        >
          <span className="text-[17px] font-semibold text-white tracking-[-0.34px]">제출하기</span>
        </button>
      </div>
